...
- 首個版本：小一至小六 61 個課題出題、直式／橫式、A4 列印與預覽、答案顯示、工作紙資料欄、設定存 localStorage。

[Unreleased]: https://github.com/forumdata-collab/mathsexercise/compare/v1.1.0...HEAD
[1.1.0]: https://github.com/forumdata-collab/mathsexercise/releases/tag/v1.1.0
[1.0.0]: https://github.com/forumdata-collab/mathsexercise/releases/tag/v1.0.0
